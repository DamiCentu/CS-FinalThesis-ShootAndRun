...
Shader "myShaders/MinibossShader"
{
	Properties
	{
		...
		_enemigo2_DefaultMaterial_Normal("enemigo 2_DefaultMaterial_Normal", 2D) = "bump" {}
		_enemigo2_DefaultMaterial_MetallicSmoothness("enemigo 2_DefaultMaterial_MetallicSmoothness", 2D) = "white" {}
		_miniBoss_DefaultMaterial_Emission("miniBoss_DefaultMaterial_Emission", 2D) = "white" {}
	...
	SubShader
	{
		...
		uniform sampler2D _miniBoss_DefaultMaterial_Emission;
		uniform float4 _miniBoss_DefaultMaterial_Emission_ST;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Normal = UnpackNormal( tex2D( _enemigo2_DefaultMaterial_Normal, uv_enemigo2_DefaultMaterial_Normal ) );
			...
			float2 uv_miniBoss_DefaultMaterial_Emission = i.uv_texcoord * _miniBoss_DefaultMaterial_Emission_ST.xy + _miniBoss_DefaultMaterial_Emission_ST.zw;
			o.Emission = ( lerpResult21 + tex2D( _miniBoss_DefaultMaterial_Emission, uv_miniBoss_DefaultMaterial_Emission ) ).rgb;
...
/*ASEBEGIN
Version=13701
733;128;668;571;1958.525;-116.4652;1.660988;False;False
...
Node;AmplifyShaderEditor.RangedFloatNode;19;-1933.755,672.4882;Float;False;Property;_Berserker;Berserker;5;0;0;0;1;0;1;FLOAT
...
Node;AmplifyShaderEditor.SamplerNode;23;-1663.117,809.9919;Float;True;Property;_miniBoss_DefaultMaterial_Emission;miniBoss_DefaultMaterial_Emission;8;0;Assets/Art/texturas enemigos/New mini boss/miniBoss_DefaultMaterial_Emission.png;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0.0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1.0;False;5;COLOR;FLOAT;FLOAT;FLOAT;FLOAT
...
ASEEND*/
//CHKSM=43520E8475A574220350806FF276F7A25B13F9ED