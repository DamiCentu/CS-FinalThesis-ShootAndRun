...
Shader "WaterShader"
{
	...
	SubShader
	{
		...
		{
			float2 texCoordDummy19 = i.uv_DummyTex*float2( 5,5 ) + float2( 0,0 );
			float2 panner20 = ( texCoordDummy19 + 1.0 * _Time.y * float2( 0.09,0 ));
			float2 texCoordDummy22 = i.uv_DummyTex*float2( 6,6 ) + float2( 0,0 );
			float2 panner24 = ( texCoordDummy22 + 1.0 * _Time.y * float2( -0.01,-0.01 ));
...
/*ASEBEGIN
Version=13701
806;104;668;571;447.0329;96.70678;1.288486;False;False
...
Node;AmplifyShaderEditor.Vector2Node;23;-2315.202,460.7363;Float;False;Constant;_Vector2;Vector 2;8;0;-0.01,-0.01;0;3;FLOAT2;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;19;-2419.428,50.19283;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;5,5;False;1;FLOAT2;0,0;False;5;FLOAT2;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.Vector2Node;21;-2411.653,174.759;Float;False;Constant;_Vector0;Vector 0;8;0;0.09,0;0;3;FLOAT2;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.WorldToObjectTransfNode;74;-1160.29,879.9316;Float;False;1;0;FLOAT4;0,0,0,1;False;5;FLOAT4;FLOAT;FLOAT;FLOAT;FLOAT
...
Node;AmplifyShaderEditor.AbsOpNode;78;-1188.985,1072.031;Float;False;1;0;COLOR;0,0,0,0;False;1;COLOR
Node;AmplifyShaderEditor.RangedFloatNode;2;-228.5117,243.3016;Float;False;Property;_Smoothness;Smoothness;6;0;2.8;0;0;0;1;FLOAT
...
ASEEND*/
//CHKSM=9D15A3C1096E817CF24B17BE8058387C40A406CE