...
public class PowerUpChaserEnemy : AbstractEnemy, IHittable {
    ...
    void OnDestroyCustom(bool makeParticles) {
        ...
        EventManager.instance.ExecuteEvent("EnemyDead", new object[] { _actualWave, _actualSectionNode, this, makeParticles });//true es para saber si toco 1 power up para en el destroy en el section node tirar el evento de particle
    }
