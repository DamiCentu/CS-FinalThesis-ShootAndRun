...
public class BossIntro : MonoBehaviour,BossActions
{
    ...
    void BossActions.Begin(AbstractBoss boss)
    {
        ...
        this.boss =(Boss) boss;
        this.boss.transform.LookAt(this.boss.player.transform.position);
        positionToAim = new Vector3(this.boss.player.transform.position.x, this.boss.transform.position.y, this.boss.player.transform.position.z);
    }
